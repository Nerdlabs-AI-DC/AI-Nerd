...
CHEAP_MODEL = "arcee-ai/trinity-large-preview:free" # Cheaper model to use for natural replies and after daily limit is reached (default: "tngtech/tng-r1t-chimera:free")
