...
MODEL = "deepseek/deepseek-v4-flash" # Main model to use (default: "deepseek/deepseek-v4-flash")
CHEAP_MODEL = "deepseek/deepseek-v4-flash:free" # Cheaper model to use for natural replies and after daily limit is reached (default: "deepseek/deepseek-v4-flash:free")
EMBED_MODEL = "openai/text-embedding-3-small" # Model to use for memory embeddings (default: "openai/text-embedding-3-small")
COMMANDS_MODEL = "openai/gpt-5.4-mini" # Model to use without personality (default: "openai/gpt-5.4-mini")
